      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Game Weeks <span class="caret"></span></a>
              <ul class="dropdown-menu">
              <li class="dropdown-header">Weekly Menu</li>
                <li role="separator" class="divider"></li>
                <li><a href="/weeklys/index">View</a></li>
              </ul>
            </li>
          </ul>
        </div><!--/.nav-collapse -->
